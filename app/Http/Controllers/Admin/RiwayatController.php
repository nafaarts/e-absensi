...
class RiwayatController extends Controller
{
    public function riwayat(User $user)
    {
        ...
        // ambil data absensi dari database dalam periode yang ditentukan dan id user dari paramter
        ...
        // tampilkan halaman riwayat yang ada di folder resources/views/admin/riwayat/riwayat.blade.php
        // dan lampirkan variable variable yang diperlukan ke dalam compact()
        return view('admin.riwayat.riwayat', compact('user', 'periode', 'hari', 'selisih', 'dataAbsensi', 'bulanSelanjutnya', 'bulanSebelumnya'));
    }
